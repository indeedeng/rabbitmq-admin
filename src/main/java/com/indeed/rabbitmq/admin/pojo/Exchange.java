...
public class Exchange {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(name).append(vhost).append(type).append(durable).append(autoDelete).append(internal).append(messageStats).append(arguments).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(vhost, rhs.vhost).append(type, rhs.type).append(durable, rhs.durable).append(autoDelete, rhs.autoDelete).append(internal, rhs.internal).append(messageStats, rhs.messageStats).append(arguments, rhs.arguments).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
